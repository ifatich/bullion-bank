...
const emit = defineEmits<{
  'preview-admin-user': [adminUser: AdminUser]
  'delete-admin-user': [adminUser: AdminUser]
}>()
...
<template>
  <section class="admin-table-card" aria-labelledby="admin-user-table-title">
    <TableHeader
      title="Admin User"
          ...
          <tr v-for="(adminUser, index) in paginatedAdminUsers" :key="`${adminUser.adminId}-${index}`">
            ...
            <td>
              <div class="action-buttons">
                <GButton
                  :id="`admin-user-preview-${index}`"
                  label="Preview"
                  type="neutral"
                  size="sm"
                  @click="emit('preview-admin-user', adminUser)"
                />
                <GButton
                  :id="`admin-user-delete-${index}`"
                  label="Delete"
                  type="neutral"
                  size="sm"
