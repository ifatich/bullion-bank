...
import AdminTransactionDetailModal from '@/components/modules/admin/transaction-history/AdminTransactionDetailModal.vue'
import { useAppAlert } from '@/hooks/useAppAlert'
import type { TransactionHistoryResponse } from '@/types/transaction'
import adminTransactionHistoryMock from '@/utils/data/admin-transaction-history.mock.json'
import { generatePdfEStatement } from '@/utils/generate-pdf-statement.util'

const transactionHistoryData = adminTransactionHistoryMock as TransactionHistoryResponse
...
<template>
  <section class="history-card" aria-labelledby="transaction-history-title">
    ...
    >
      <template #actions>
        <GButton label="Export" type="neutral" size="md" @click="exportTransactions" style="min-width: 164px;" />
      </template>
    </TableHeader>
